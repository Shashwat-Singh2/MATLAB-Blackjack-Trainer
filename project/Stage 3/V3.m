...
% V3 - This version itegrates the black jack busting mechanics
%Date - 20/03/2025
%Improvements/bug testing in this version- if statements for busting if ace is involved
clc
clear
