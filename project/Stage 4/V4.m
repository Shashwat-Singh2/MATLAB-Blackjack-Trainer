...
% V4 - This version integrates the dealers moves
%Date - 21/03/2025
%Improvements/bug testing in this version- fixing blackjack bug feature
%which wouldnt recognise total properly
clc
clear
...
deald_count = 0;
if bust == 0;
    while dealer_sum(length(dealer_sum)) < 17
