...
% V8 - This version makes a user interface, please run code with undocked
% command window (click on command window then press Ctrl+Shift+U)
%Date - 27/03/2025
%Improvements/bug testing in this version-including fucntions, ascii art,
%audio and tidyed up code to make more pleasent playing experience
clc
clear
...
while (play == "yes") || (play == "y") ||(play == "Yes") || (play == "Y")
    ...
    %result = 999;
    [x, fs] = audioread("dealer_wins.wav");
    [z, fs] = audioread("kaching.mp3");
    if bust == 1
        fprintf("\n dealer wins...");
        sound(x, fs);
        result = 0;
